...
if [[ "$V627_BUILD" == "1" ]]; then
  ...
  [[ "$PARAMS" == *"research_v627_balance_gate=1"* ]] || {
    echo "ERROR: v6.2.7 build without research_v627_balance_gate=1 in PARAMS." >&2
    exit 1
  }
