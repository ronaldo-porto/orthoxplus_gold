...
"""Production OFI and delayed adverse-selection measurement.
...
with frozen priors. Sparse books fall back to 0 rather than an
optimistic mean.
"""
...
from score_ev import adverse_selection_risk, conservative_markout_bps
