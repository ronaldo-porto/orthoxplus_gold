...
class Strategy5(Strategy3):
    ...
    def _hjb_min_expected_pnl(self, below_floor: bool) -> float:
        ...
        if below_floor and self.enable_floor_awareness:
            # Treat the boost as a relative safety margin. Multiplying it by
            # floor_pnl_scale made the old default (~0.003) too restrictive
            # and could starve Kappa activity.
            base = max(
                threshold,
