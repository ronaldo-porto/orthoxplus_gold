...
"""Production MarketRegime V2 and ScoreRegime.

Promoted from verified Research V4.3 Phase 1. No Strategy1 / Research runtime
imports. MarketRegime is cross-sectional book statistics only. ScoreRegime is
Kappa / coverage only. Missing parent trigger fields must never become STRESSED.
"""
