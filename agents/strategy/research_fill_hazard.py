...
"""Research V4.3 Phase 3: discrete fill-hazard with shrinkage and calibration.
...
right-censored. Predictions are P(event by chosen TTL), not fill/no-fill
ignoring time.
"""
...
class FillHazardModel:
    ...
    def select_policy_probability(
        ...
        *,
        ...
        if use_for_policy and predicted.usable:
            return predicted.any_fill
        return _clip(old_prob, 0.0, 1.0)
