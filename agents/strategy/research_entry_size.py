...
def admit_minimum_order(
    *,
    ...
    one_away_min_safe_fraction: float = 0.15,
    one_away_min_exit_fraction: float = 0.20,
    ...
    if band == ADMISSION_UNSAFE:
        ...
        one_away_safe_fraction = max(0.15, min(1.0, _finite(one_away_min_safe_fraction, 0.15)))
        one_away_exit_fraction = max(0.20, min(1.0, _finite(one_away_min_exit_fraction, 0.20)))
        one_away_ok = (
