...
# V2 keeps Strategy1 entry sizing conservative but gives inventory exits more breadth.
...
research_bootstrap_force_close_ticks=60 research_bootstrap_force_close_min_bps=-5.0 \
research_bootstrap_hard_close_ticks=180 research_dust_safe_close=1 research_rotate_jsonl=1"
