...
# V4.12.10 deployment compatibility checks
...
# SN79 testnet launcher for Strategy1_Research V4.12.10 Final Bounded Stale-Taker Bridge Research (Miner 1).
...
grep -q 'RESEARCH_POLICY_VERSION = "rolling_deadline_rescue_v4_12_10"' "$AGENT_PATH/Strategy1_Research.py" || {
  echo "ERROR: Strategy1_Research.py is not rolling_deadline_rescue_v4_12_10" >&2
  exit 1
}
...
echo "[Strategy1_Research] version=rolling_deadline_rescue_v4_12_10"
