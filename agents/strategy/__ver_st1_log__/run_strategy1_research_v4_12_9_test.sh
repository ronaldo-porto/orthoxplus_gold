...
grep -q 'RESEARCH_POLICY_VERSION = "rolling_deadline_rescue_v4_12_9"' "$AGENT_PATH/Strategy1_Research.py" || {
  echo "ERROR: Strategy1_Research.py is not rolling_deadline_rescue_v4_12_9" >&2
  exit 1
}
...
echo "[Strategy1_Research] version=rolling_deadline_rescue_v4_12_9"
