...
"""V4.9 Completion/INACTIVE bridge regression tests."""
...
def test_policy_version_and_lane_defaults_are_v49():
    assert 'RESEARCH_POLICY_VERSION = "hybrid_score_taker_v4_9"' in RESEARCH_SRC
    ...
    assert "research_coverage_slots=6 research_completion_slots=6" in LAUNCHER_SRC
