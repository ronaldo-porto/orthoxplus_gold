...
class Strategy1_Research(Strategy1_Debug):
    ...
    def _research_apply_unified_exit(
        ...
        *,
        ...
        if unified.action == UNIFIED_KEEP_MAKER and not liveness_parked_now:
    ...
    def _place_skewed_quotes(
        ...
        # V4.13.3: preserve CORE_PROBE lane identity from screening through
        # execution.  A probe is intentionally already Kappa-eligible, so the
        # legacy completion predicate returns False for it.  Without this
        # explicit authority the book is reclassified as COVERAGE here and is
        # rejected against the COMPLETION grant as LANE_NOT_GRANTED.
        ...
        completion_candidate = execution_completion_candidate(
