...
from research_inventory_liveness import (
    ...
    BOUNDED_LOSS_ESCAPE_VERSION, bounded_loss_escape_applies,
...
if BOUNDED_LOSS_ESCAPE_VERSION != "bounded_loss_escape_v4_14_0":
    raise SystemExit("ERROR: stale V4.14.0 bounded-loss helper")
if not bounded_loss_escape_applies(
    taker_net_bps=-16.28, peak_taker_net_bps=-11.43, inventory_age=2.0,
    soft_floor_bps=-8.0, hard_floor_bps=-25.0, min_drawdown_bps=2.0,
):
    raise SystemExit("ERROR: V4.14.0 Book24 bounded-loss recycle contract failed")
if bounded_loss_escape_applies(
    taker_net_bps=-26.0, peak_taker_net_bps=-11.43, inventory_age=2.0,
    soft_floor_bps=-8.0, hard_floor_bps=-25.0, min_drawdown_bps=2.0,
):
    raise SystemExit("ERROR: V4.14.0 bounded-loss hard corridor widened")
...
research_enable_fast_candidate_screen=1 research_candidate_count=10 research_cohort_size=8 research_cohort_exploration_slots=1 research_max_open_books=6 research_max_active_open_books=6 research_max_total_open_books=8 research_max_parked_open_books=4 research_max_total_abs_base=2.0 research_kappa_conversion_pressure_enabled=1 research_kappa_conversion_reserve_slots=3 research_kappa_exploration_slots=1 research_kappa_flywheel_enabled=1 research_kappa_productivity_enabled=1 research_core_probe_enabled=1 research_persistent_maker_enabled=1 research_hysteresis_min_price_ticks=3 research_post_only_safety_ticks=2 \
