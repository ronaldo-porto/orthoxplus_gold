...
class Strategy1_Research(Strategy1_Debug):
    RESEARCH_POLICY_VERSION = "authoritative_l1_guard_v4_12_14"
    ...
    def onTrade(self, event, validator: str | None = None) -> None:
        ...
        if transition in {"FLAT", "CROSS"}:
            # The rejected Maker exit belongs to the old inventory lifecycle.
            # Once flat or crossed, both side guards for this book are obsolete.
