...
# V4.12.11 deployment compatibility checks
...
# SN79 testnet launcher for Strategy1_Research V4.12.11 ONE_AWAY Completion Rescue Research (Miner 1).
...
grep -q 'RESEARCH_POLICY_VERSION = "one_away_completion_v4_12_11"' "$AGENT_PATH/Strategy1_Research.py" || {
  echo "ERROR: Strategy1_Research.py is not one_away_completion_v4_12_11" >&2
  exit 1
}
...
echo "[Strategy1_Research] version=one_away_completion_v4_12_11"
