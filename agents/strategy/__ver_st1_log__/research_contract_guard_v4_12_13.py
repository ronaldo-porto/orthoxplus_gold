...
"""Pending-reprice post-only contract-rejection guard for Research V4.12.13.
...
V4.12.13 makes a real reject a pending-reprice state:
...
CONTRACT_GUARD_VERSION = "pending_reprice_contract_guard_v4_12_13"
