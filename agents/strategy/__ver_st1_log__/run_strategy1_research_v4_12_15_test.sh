...
# SN79 testnet launcher for Strategy1_Research V4.12.15 Inventory Liveness Research (Miner 1).
...
grep -q 'RESEARCH_POLICY_VERSION = "inventory_liveness_v4_12_15"' "$AGENT_PATH/Strategy1_Research.py" || {
  echo "ERROR: Strategy1_Research.py is not inventory_liveness_v4_12_15" >&2
  exit 1
}
...
research_enable_fast_candidate_screen=1 research_candidate_count=10 research_cohort_size=8 research_cohort_exploration_slots=1 research_max_open_books=6 research_max_active_open_books=6 research_max_total_open_books=12 research_max_parked_open_books=6 research_max_total_abs_base=3.0 \
...
echo "[Strategy1_Research] version=inventory_liveness_v4_12_15"
