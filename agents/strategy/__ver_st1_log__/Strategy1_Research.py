...
class Strategy1_Research(Strategy1_Debug):
    RESEARCH_POLICY_VERSION = "rolling_deadline_rescue_v4_12_8"
    ...
    def initialize(self) -> None:
        ...
        self.research_qualified_suppression_min_incomplete = max(
            1, min(16, int(getattr(cfg, "research_qualified_suppression_min_incomplete", 2)))
        )
        ...
        self.research_score_target_books = max(
            1, min(128, int(getattr(cfg, "research_score_target_books", 45)))
        )
        ...
        self._enqueue({
            ...
            "qualified_suppression_min_incomplete": int(getattr(self, "research_qualified_suppression_min_incomplete", 2)),
            ...
            "score_target_books": int(getattr(self, "research_score_target_books", 45)),
    ...
    def _research_fast_screen(self, state) -> ScreenResult:
        ...
        lane_rows, qualified_suppressed_ids, productive_incomplete = apply_breadth_rotation_gate(
            ...
            min_productive_incomplete=int(
                getattr(self, "research_qualified_suppression_min_incomplete", 2) or 2
            ),
        )
        ...
        try:
            ...
            self._emit(
                ...
                score_target=int(getattr(self, "research_score_target_books", 45)),
                score_deficit=max(0, int(getattr(self, "research_score_target_books", 45)) - len(score_qualified_ids)),
