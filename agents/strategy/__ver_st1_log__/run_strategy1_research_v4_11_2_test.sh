...
# SN79 testnet launcher for Strategy1_Research V4.11.2 Aggressive Positive-EV Completion Research (Miner 1).
# Default PM2 name: sn79-m1 | Default Axon port: 8091
set -euo pipefail
# VERSION ARCHIVE: V4.11.2 launcher. Runtime still uses live agents/strategy/*.py.
...
grep -q 'RESEARCH_POLICY_VERSION = "hybrid_score_taker_v4_11_2"' "$AGENT_PATH/Strategy1_Research.py" || {
  echo "ERROR: Strategy1_Research.py is not hybrid_score_taker_v4_11_2" >&2
  exit 1
}
...
echo "[Strategy1_Research] version=hybrid_score_taker_v4_11_2"
