...
class Strategy1_Research(Strategy1_Debug):
    RESEARCH_POLICY_VERSION = "hybrid_score_taker_v4_11"
    ...
    def initialize(self) -> None:
        ...
        self._research_taker_authority_counts = {"ECONOMIC": 0, "SCORE": 0, "RISK": 0}
    ...
    def _research_manage_realization(
        ...
        if not isinstance(auth_counts, dict):
            auth_counts = {"ECONOMIC": 0, "SCORE": 0, "RISK": 0}
    ...
    def _format_human(self, r: dict[str, Any]) -> str | None:
        ...
        if typ == "HYBRID_SUMMARY":
            return (
                ...
                f"auth=e{r.get('economic_taker_auth')}/s{r.get('score_taker_auth')}/r{r.get('risk_taker_auth')} "
