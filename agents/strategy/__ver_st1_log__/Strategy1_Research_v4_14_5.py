...
class Strategy1_Research(Strategy1_Debug):
    ...
    RESEARCH_KAPPA_SCHEDULER_VERSION = TOTAL_SCORE_FRONTIER_VERSION
    ...
    def initialize(self) -> None:
        ...
        self.research_total_score_full_breadth_books = max(
            self.research_total_score_ignition_books,
            min(128, int(getattr(cfg, "research_total_score_full_breadth_books", 80))),
        )
        self.research_total_score_frontier_band = max(
            0, min(8, int(getattr(cfg, "research_total_score_frontier_band", 2)))
        )
        ...
        self.research_score_target_books = max(
            1, min(128, int(getattr(
                cfg, "research_score_target_books",
        ...
        self._enqueue({
            ...
            "score_target_books": int(getattr(self, "research_score_target_books", 80)),
