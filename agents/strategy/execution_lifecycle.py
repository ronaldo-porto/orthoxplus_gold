...
"""Production quote lifecycle and fill classification.

Promoted from verified Research V4.3. Uses the runtime exchange minimum order
size; never hard-codes 0.25. No Strategy1 / Research runtime imports.
"""
