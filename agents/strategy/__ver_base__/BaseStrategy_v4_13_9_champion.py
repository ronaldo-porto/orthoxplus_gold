...
"""BaseStrategy — frozen SN79 St6.4 V4.13.9 production champion.

Promotion chain:
    Strategy1_Research V4.13.9 (verified) -> BaseStrategy -> AdaptiveAgent
...
class BaseStrategy(Strategy1_Research):
    """Frozen V4.13.9 Base champion for AdaptiveAgent promotion."""
    ...
    KAPPA_PRODUCTIVITY_POLICY_VERSION = "simplified_kappa_productivity_v4_13_9"
