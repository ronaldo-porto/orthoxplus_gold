...
grep -q 'DEPLOY_POLICY_VERSION = "base_v4_13_8_champion"' "$AGENT_PATH/BaseStrategy.py" || {
  echo "ERROR: BaseStrategy.py is not base_v4_13_8_champion" >&2
  exit 1
}
...
print("BaseStrategy V4.13.8 champion contract OK")
PYBASE4138
echo "[BaseStrategy] version=base_v4_13_8_champion"
