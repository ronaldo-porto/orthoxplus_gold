...
**Scope:** study-only. No strategy, launcher, or validator code was modified except creation of this document.  
...
|---|---|---|---|---|
| Research | `agents/strategy/Strategy1_Research.py` | `RESEARCH_POLICY_VERSION = "dust_actionable_v4_2_strict"` | `Strategy1_Debug` | **Yes:** `Strategy1.py`, `Strategy1_Debug.py` |
...
- Research: `agents/strategy/__ver_st1_log__/` (`v2`, `v2_strict`, `v3_strict`, `v4_strict`, `v4_1_strict`, `v4_2_strict_deploy.py`)
