...
def test_a160_version_contract():
    pytest.skip("superseded by A1.6.1 liveness repair")
    assert 'SIMPLE_POLICY_VERSION = "strategy1_direct_v4_16_2_a1_6_0"' in SRC
    ...
    assert DIRECT_FASTPATH_VERSION == 'direct_fastpath_v4_16_2_a1_6_0'
