...
def test_a19_version_contract():
    ...
    assert 'SIMPLE_ENGINE_VERSION = "strategy1_direct_v4_16_2_a1_9_0"' in SRC
    assert DIRECT_EXIT_REFRESH_VERSION == "direct_exit_refresh_v4_16_2_a1_9_0"
...
def test_launcher_pins_phase_a_version_and_keeps_baseline_ttl():
    assert "strategy1_direct_v4_16_2_a1_9_0" in LAUNCHER
    # Phase B is what raises the TTL; Phase A must run on the A1.7.5 default.
    assert "research_profitable_exit_ttl_ms=" not in LAUNCHER
